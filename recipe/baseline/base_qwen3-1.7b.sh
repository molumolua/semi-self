...
exp_name=${exp_name:-"baseline-model-${model_name}-lr-${lr}-bsz-${train_prompt_bsz}-n_resp-${n_resp_per_prompt}-mini-${train_prompt_mini_bsz}"}
...
PYTHONUNBUFFERED=1 python3 -m recipe.baseline.main_dapo \
